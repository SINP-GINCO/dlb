...
try {
	...
	execCustSQLFile("$currentDir/sensitive_automatic.sql", $config);
	execCustSQLFile("$currentDir/especesensible.sql", $config);
	execCustSQLFile("$currentDir/especesensiblelistes.sql", $config);
