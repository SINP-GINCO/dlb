...
INSERT INTO role(role_label, role_definition, is_default) VALUES ('Administrateur', 'Administrateur de plateforme', false);
INSERT INTO role(role_label, role_definition, is_default) VALUES ('Pétitionnaire', 'Pétitionnaire', true);
...
INSERT INTO permission(permission_code, permission_label, permission_group_code, description) VALUES 
  ...
  ('CANCEL_DATASET_PUBLICATION', 'Annuler le dépôt d''un jdd et dépublier les soumissions','JDD_MANAGEMENT','Annuler le dépôt d''un jdd et dépublier les soumissions'),
  ('VIEW_PUBLISHED_DATASETS','Visualiser les jeux de données ayant fait l''objet d''un dépôt légal','JDD_MANAGEMENT','Visualiser les jeux de données ayant fait l''objet d''un dépôt légal');
...
INSERT INTO permission_per_role(role_code, permission_code) VALUES (3, 'VIEW_SENSITIVE');
...
INSERT INTO permission_per_role(role_code, permission_code) VALUES (3, 'GENERATE_DEE_OWN');
INSERT INTO permission_per_role(role_code, permission_code) VALUES (3, 'VIEW_PUBLISHED_DATASETS');
...
INSERT INTO permission_per_role(role_code, permission_code) VALUES (4, 'VIEW_PUBLISHED_DATASETS');
