...
INSERT INTO referentiels.liste_referentiels (table_name,label,description,"version","type","name",updated_at,url) VALUES (
  'taxref','Référentiel taxonomique TAXREF','Référentiel taxonomique : Faune, flore et fonge de France métropolitaine et d''outre-mer ','v12','referentiel','TAXREF','2018-11-23','https://inpn.mnhn.fr/telechargement/referentielEspece/taxref/12.0/menu');
INSERT INTO referentiels.liste_referentiels (table_name,label,description,"version","type","name",updated_at,url) VALUES (
