...
INSERT INTO data(data,unit,label,definition,comment) VALUES ('PROVIDER_ID','PROVIDER_ID','Organisme du compte GINCO','Organisme du compte utilisateur GINCO qui a importé la donnée dans GINCO',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('SUBMISSION_ID','Integer','Identifiant de la soumission','Identifiant de la soumission',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('OGAM_ID_table_observation','IDString','Clé primaire table observation','Clé primaire table observation',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codecommune','CodeCommuneValue','codeCommune','Code de la/les commune(s) où a été effectuée l’observation suivant le référentiel INSEE en vigueur. ',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomcommune','NomCommuneValue','nomCommune','Libellé de la/les commune(s) où a été effectuée l’observation suivant le référentiel INSEE en vigueur.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('anneerefcommune','Integer','anneeRefCommune','Année de production du référentiel INSEE, qui sert à déterminer quel est le référentiel en vigueur pour le code et le nom de la commune.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeinfogeocommune','TypeInfoGeoValue','typeInfoGeoCommune','Indique le type d''information géographique suivant la nomenclature TypeInfoGeoValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('denombrementmin','Integer','denombrementMin','Nombre minimum d''individus du taxon composant l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('denombrementmax','Integer','denombrementMax','Nombre maximum d''individus du taxon composant l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('objetdenombrement','ObjetDenombrementValue','objetDenombrement','Objet sur lequel porte le dénombrement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typedenombrement','TypeDenombrementValue','typeDenombrement','Méthode utilisée pour le dénombrement (Inspire).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codedepartement','CodeDepartementValue','codeDepartement','Code INSEE en vigueur suivant l''année du référentiel INSEE des départements, auquel l''information est rattachée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('anneerefdepartement','Integer','anneeRefDepartement','Année du référentiel INSEE utilisé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeinfogeodepartement','TypeInfoGeoValue','typeInfoGeoDepartement','Indique le type d''information géographique suivant la nomenclature TypeInfoGeoValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeen','TypeENValue','typeEN','Indique le type d’espace naturel protégé, ou de zonage (Natura 2000, Znieff1, Znieff2).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codeen','CodeENValue','codeEN','Code de l’espace naturel sur lequel a été faite l’observation, en fonction du type d''espace naturel.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('versionen','Date','versionEN','Version du référentiel consulté respectant la norme ISO 8601, sous la forme YYYY-MM-dd (année-mois-jour), YYYY-MM (année-mois), ou YYYY (année).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeinfogeoen','TypeInfoGeoValue','typeInfoGeoEN','Indique le type d''information géographique suivant la nomenclature TypeInfoGeoValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('refhabitat','CodeRefHabitatValue','refHabitat','RefHabitat correspond au référentiel utilisé pour identifier l''habitat de l''observation. Il est codé selon les acronymes utilisés sur le site de l''INPN mettant à disposition en téléchargement les référentiels "habitats" et "typologies".',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codehabitat','CodeHabitatValue','codeHabitat','Code métier de l''habitat où le taxon de l''observation a été identifié. Le référentiel Habitat est indiqué dans le champ « RefHabitat ». Il peut être trouvé dans la colonne "LB_CODE" d''HABREF.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('versionrefhabitat','CharacterString','versionRefHabitat','Version du référentiel utilisé (suivant la norme ISO 8601, sous la forme YYYY-MM-dd, YYYY-MM, ou YYYY).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codehabref','CodeHabRefValue','codeHabRef','Code HABREF de l''habitat où le taxon de l''observation a été identifié. Il peut être trouvé dans la colonne "CD_HAB" d''HabRef.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codemaille','CodeMailleValue','codeMaille','Code de la cellule de la grille de référence nationale 10kmx10km dans laquelle se situe l’observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('versionrefmaille','CharacterString','versionRefMaille','Version du référentiel des mailles utilisé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomrefmaille','CharacterString','nomRefMaille','Nom de la couche de maille utilisée : Concaténation des éléments des colonnes "couche" et "territoire" de la page http://inpn.mnhn.fr/telechargement/cartes-et-information-geographique/ref.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeinfogeomaille','TypeInfoGeoValue','typeInfoGeoMaille','Indique le type d''information géographique suivant la nomenclature TypeInfoGeoValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codeme','CodeMasseEauValue','codeME','Code de la ou les masse(s) d''eau à la (aux)quelle(s) l''observation a été rattachée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('versionme','VersionMasseDEauValue','versionME','Version du référentiel masse d''eau utilisé et prélevé sur le site du SANDRE, telle que décrite sur le site du SANDRE.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('dateme','Date','dateME','Date de consultation ou de prélèvement du référentiel sur le site du SANDRE.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeinfogeome','TypeInfoGeoValue','typeInfoGeoME','Indique le type d''information géographique suivant la nomenclature TypeInfoGeoValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('geometrie','GEOM','geometrie','La géométrie de la localisationl (au format WKT)',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('natureobjetgeo','NatureObjetGeoValue','natureObjetGeo','Nature de la localisation transmise ',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('precisiongeometrie','Integer','precisionGeometrie','Estimation en mètres d’une zone tampon autour de l''objet géographique. Cette précision peut inclure la précision du moyen technique d’acquisition des coordonnées (GPS,…) et/ou du protocole naturaliste.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('observateurnomorganisme','CharacterString','observateurNomOrganisme','Organisme(s) de la ou des personnes ayant réalisé l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('observateuridentite','CharacterString','observateurIdentite','Nom(s), prénom de la ou des personnes ayant réalisé l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('observateurmail','CharacterString','observateurMail','Mail(s) de la ou des personnes ayant réalisé l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('determinateurnomorganisme','CharacterString','determinateurNomOrganisme','Organisme de la ou les personnes ayant réalisé la détermination taxonomique de l’observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('determinateuridentite','CharacterString','determinateurIdentite','Prénom, nom de la ou les personnes ayant réalisé la détermination taxonomique de l’observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('determinateurmail','CharacterString','determinateurMail','Mail de la ou les personnes ayant réalisé la détermination taxonomique de l’observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('validateurnomorganisme','CharacterString','validateurNomOrganisme','Organisme de la personne ayant réalisée la validation scientifique de l’observation pour le Producteur.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('validateuridentite','CharacterString','validateurIdentite','Prénom, nom de la personne ayant réalisée la validation scientifique de l’observation pour le Producteur.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('validateurmail','CharacterString','validateurMail','Mail de la personne ayant réalisée la validation scientifique de l’observation pour le Producteur.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifiantorigine','CharacterString','identifiantOrigine','Identifiant unique de la Donnée Source de l’observation dans la base de données du producteur où est stockée et initialement gérée la Donnée Source. La DS est caractérisée par jddId et/ou jddCode,.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('dspublique','DSPubliqueValue','dSPublique','Indique explicitement si la DS de la DEE est publique ou privée. Définit uniquement les droits nécessaires et suffisants des DS pour produire une DEE. Ne doit être utilisé que pour indiquer si la DEE résultante est susceptible d’être floutée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('diffusionniveauprecision','NiveauPrecisionValue','diffusionNiveauPrecision','Niveau maximal de précision de la diffusion souhaitée par le producteur vers le grand public. Ne concerne que les DEE non sensibles.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('deefloutage','DEEFloutageValue','dEEFloutage','Indique si un floutage a été effectué lors de la transformation en DEE. Cela ne concerne que des données d''origine privée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensible','SensibleValue','sensible','Indique si l''observation est sensible d''après les principes du SINP. Va disparaître.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensiniveau','SensibiliteValue','sensiNiveau','Indique si l''observation ou le regroupement est sensible d''après les principes du SINP et à quel degré. La manière de déterminer la sensibilité est définie dans le guide technique des données sensibles disponible sur la plate-forme naturefrance.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensidateattribution','DateTime','sensiDateAttribution','Date à laquelle on a attribué un niveau de sensibilité à la donnée. C''est également la date à laquelle on a consulté le référentiel de sensibilité associé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensireferentiel','CharacterString','sensiReferentiel','Référentiel de sensibilité consulté lors de l''attribution du niveau de sensibilité.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensiversionreferentiel','CharacterString','sensiVersionReferentiel','Version du référentiel consulté. Peut être une date si le référentiel n''a pas de numéro de version. Doit être rempli par "NON EXISTANTE" si un référentiel n''existait pas au moment de l''attribution de la sensibilité par un Organisme.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('statutsource','StatutSourceValue','statutSource','Indique si la DS de l’observation provient directement du terrain (via un document informatisé ou une base de données), d''une collection, de la littérature, ou n''est pas connu.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jddcode','CharacterString','jddCode','Nom, acronyme, ou code de la collection du jeu de données dont provient la donnée source.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jddid','CharacterString','jddId','Identifiant pour la collection ou le jeu de données source d''où provient l''enregistrement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jddsourceid','CharacterString','jddSourceId','Il peut arriver, pour un besoin d''inventaire, par exemple, qu''on réutilise une donnée en provenance d''un autre jeu de données DEE déjà existant au sein du SINP.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jddmetadonneedeeid','CharacterString','jddMetadonneeDEEId','Identifiant permanent et unique de la fiche métadonnées du jeu de données auquel appartient la donnée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('organismegestionnairedonnee','CharacterString','organismeGestionnaireDonnee','Nom de l’organisme qui détient la Donnée Source (DS) de la DEE et qui en a la responsabilité. Si plusieurs organismes sont nécessaires, les séparer par des virgules.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codeidcnpdispositif','IDCNPValue','codeIDCNPDispositif','Code du dispositif de collecte dans le cadre duquel la donnée a été collectée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('deedatetransformation','DateTime','dEEDateTransformation','Date de transformation de la donnée source (DSP ou DSR) en donnée élémentaire d''échange (DEE).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('deedatedernieremodification','DateTime','dEEDateDerniereModification','Date de dernière modification de la donnée élémentaire d''échange. Postérieure à la date de transformation en DEE, égale dans le cas de l''absence de modification.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('referencebiblio','CharacterString','referenceBiblio','Référence de la source de l’observation lorsque celle-ci est de type « Littérature », au format ISO690. La référence bibliographique doit concerner l''observation même et non uniquement le taxon ou le protocole.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('orgtransformation','CharacterString','orgTransformation','Nom de l''organisme ayant créé la DEE finale (plate-forme ou organisme mandaté par elle).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifiantpermanent','CharacterString','identifiantPermanent','Identifiant unique et pérenne de la Donnée Elémentaire d’Echange de l''observation dans le SINP attribué par la plateforme régionale ou thématique.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('statutobservation','StatutObservationValue','statutObservation','Indique si le taxon a été observé directement ou indirectement (indices de présence), ou non observé ',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomcite','CharacterString','nomCite','Nom du taxon cité à l’origine par l’observateur. Celui-ci peut être le nom scientifique reprenant idéalement en plus du nom latin, l’auteur et la date. ',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jourdatedebut','Date','jourDateDebut','Date du jour, dans le système local de l’observation dans le système grégorien. En cas d’imprécision, cet attribut représente la date la plus ancienne de la période d’imprécision.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('jourdatefin','Date','jourDateFin','Date du jour, dans le système local de l’observation dans le système grégorien. En cas d’imprécision sur la date, cet attribut représente la date la plus récente de la période d’imprécision.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('altitudemin','Decimal','altitudeMin','Altitude minimum de l’observation en mètres.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('altitudemax','Decimal','altitudeMax','Altitude maximum de l’observation en mètres.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('profondeurmin','Decimal','profondeurMin','Profondeur minimale de l’observation en mètres selon le référentiel des profondeurs indiqué dans les métadonnées (système de référence spatiale verticale).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('profondeurmax','Decimal','profondeurMax','Profondeur maximale de l’observation en mètres selon le référentiel des profondeurs indiqué dans les métadonnées (système de référence spatiale verticale).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('cdnom','CharacterString','cdNom','Code du taxon « cd_nom » de TaxRef référençant au niveau national le taxon. Le niveau ou rang taxinomique de la DEE doit être celui de la DS.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('cdref','CharacterString','cdRef','Code du taxon « cd_ref » de TAXREF référençant au niveau national le taxon. Le niveau ou rang taxinomique de la DEE doit être celui de la DS.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('versiontaxref','CharacterString','versionTAXREF','Version du référentiel TAXREF utilisée pour le cdNom et le cdRef.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('datedetermination','Date','dateDetermination','Date/heure de la dernière détermination du taxon de l’observation dans le système grégorien.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('organismestandard','CharacterString','organismeStandard','Nom(s) de(s) organisme(s) qui ont participés à la standardisation de la DS en DEE (codage, formatage, recherche des données obligatoires) ',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('commentaire','CharacterString','commentaire','Champ libre pour informations complémentaires indicatives sur le sujet d''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomattribut','CharacterString','nomAttribut','Libellé court et implicite de l’attribut additionnel.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('definitionattribut','CharacterString','definitionAttribut','Définition précise et complète de l''attribut additionnel.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('valeurattribut','CharacterString','valeurAttribut','Valeur qualitative ou quantitative de l’attribut additionnel.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('uniteattribut','CharacterString','uniteAttribut','Unité de mesure de l’attribut additionnel.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('thematiqueattribut','CharacterString','thematiqueAttribut','Thématique relative à l''attribut additionnel (mot-clé).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeattribut','TypeAttributValue','typeAttribut','Indique si l''attribut additionnel est de type quantitatif ou qualitatif.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('obsdescription','CharacterString','obsDescription','Description libre de l''observation, aussi succincte et précise que possible.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('obsmethode','ObservationMethodeValue','obsMethode','Indique de quelle manière on a pu constater la présence d''un sujet d''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occetatbiologique','OccurrenceEtatBiologiqueValue','occEtatBiologique','Code de l''état biologique de l''organisme au moment de l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occmethodedetermination','CharacterString','occMethodeDetermination','Description de la méthode utilisée pour déterminer le taxon lors de l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occnaturalite','OccurrenceNaturalisteValue','occNaturalite','Naturalité de l''occurrence, conséquence de l''influence anthropique directe qui la caractérise. Elle peut être déterminée immédiatement par simple observation, y compris par une personne n''ayant pas de formation dans le domaine de la biologie considéré.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occsexe','OccurrenceSexeValue','occSexe','Sexe du sujet de l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occstadedevie','OccurrenceStadeDeVieValue','occStadeDeVie','Stade de développement du sujet de l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occstatutbiologique','OccurrenceStatutBiologiqueValue','occStatutBiologique','Comportement général de l''individu sur le site d''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('occstatutbiogeographique','OccurrenceStatutBiogeographiqueValue','occStatutBioGeographique','Couvre une notion de présence (présence/absence), et d''origine (indigénat ou introduction)',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('preuveexistante','PreuveExistanteValue','preuveExistante','Indique si une preuve existe ou non. Par preuve on entend un objet physique ou numérique permettant de démontrer l''existence de l''occurrence et/ou d''en vérifier l''exactitude.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('preuvenonnumerique','CharacterString','preuveNonNumerique','Adresse ou nom de la personne ou de l''organisme qui permettrait de retrouver la preuve non numérique de L''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('preuvenumerique','CharacterString','preuveNumerique','Adresse web à laquelle on pourra trouver la preuve numérique ou l''archive contenant toutes les preuves numériques (image(s), sonogramme(s), film(s), séquence(s) génétique(s)...).',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('obscontexte','CharacterString','obsContexte','Description libre du contexte de l''observation, aussi succincte et précise que possible.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifiantregroupementpermanent','CharacterString','identifiantRegroupementPermanent','Identifiant permanent du regroupement, sous forme d''UUID.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('methoderegroupement','CharacterString','methodeRegroupement','Description de la méthode ayant présidé au regroupement, de façon aussi succincte que possible : champ libre.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typeregroupement','TypeRegroupementValue','typeRegroupement','Indique quel est le type du regroupement suivant la liste typeRegroupementValue.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('altitudemoyenne','Decimal','altitudeMoyenne','Altitude moyenne considérée pour le regroupement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('profondeurmoyenne','Decimal','profondeurMoyenne','Profondeur moyenne considérée pour le regroupement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensimanuelle','SensiManuelleValue','sensiManuelle','Indique si la sensibilité a été attribuée manuellement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('sensialerte','SensiAlerteValue','sensiAlerte','Indique si la sensibilité est à attribuer manuellement.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codemaillecalcule','CodeMailleCalculeValue','codeMailleCalcule','Code de la maille calculé',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codecommunecalcule','CodeCommuneCalculeValue','codeCommuneCalcule','Code de la commune calculé',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomcommunecalcule','NomCommuneCalculeValue','nomCommuneCalcule','Nom de la commune calculé',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('codedepartementcalcule','CodeDepartementCalculeValue','codeDepartementCalcule','Code du département calculé',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('heuredatedebut','Time','heureDateDebut','Heure du jour, dans le système local de l’observation dans le système grégorien. En cas d’imprécision, cet attribut représente la date la plus ancienne de la période d’imprécision.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('heuredatefin','Time','heureDateFin','Heure du jour, dans le système local de l’observation dans le système grégorien. En cas d’imprécision sur la date, cet attribut représente la date la plus récente de la période d’imprécision.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomvalide','CharacterString','nomValide','Le nomValide est le nom du taxon correspondant au cd_ref',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('tpsid','Integer','tpsId','Identifiant TPS','Identifiant TPS');
INSERT INTO data(data,unit,label,definition,comment) VALUES ('cdnomcalcule','TaxRefValue','cdNomCalcule','Code du taxon « cd_nom » calculé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('cdrefcalcule','TaxRefValue','cdRefCalcule','Code du taxon « cd_ref » calculé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('taxostatut','TaxoStatutValue','taxoStatut','Statut du taxon pour la migration TAXREF.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('taxomodif','TaxoModifValue','taxoModif','Modification effectuée sur le taxon lors de la migration TAXREF.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('taxoalerte','TaxoAlerteValue','taxoAlerte','Alerte sur le taxon pour la migration TAXREF.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('USER_LOGIN','USER_LOGIN','Utilisateur','Utilisateur',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('OGAM_ID_table_station','IDString','Clé primaire table station','Clé primaire table station',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifiantstasinp','CharacterString','identifiantStaSINP','Identifiant unique de la station observée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifiantoriginestation','CharacterString','identifiantOrigineStation','Identifiant unique de la donnée de station dans la base de données du producteur où est stockée et initialement gérée la donnée d''origine.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('dateimprecise','BOOLEAN','dateImprecise','Permet d''indiquer qu''une date est imprécise et que jourDateDebut / jourDateFin recouvre une période d''imprécision.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('observateur','CharacterString','observateur','Identité et organisme de la ou des personnes ayant réalisé l''observation.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('nomstation','CharacterString','nomStation','Nom ou code éventuel de la station.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('estcomplexehabitats','ComplexeHabitatValue','estComplexeHabitats','Permet de préciser que la station est un complexe d''habitats.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('exposition','ExpositionValue','exposition','Exposition de la station.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('surface','Decimal','surface','Superficie de la station.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('methodecalculsurface','MethodeCalculSurfaceValue','methodeCalculSurface','Méthode de calcul pour la détermination de la surface.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('usage','CharacterString','usage','Usage/activité pratiquée sur l''habitat, si nécessaire, fondé sur la notion d''impact anthropique.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typesol','TypeSolValue','typeSol','Type de sol de la zone considérée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('geologie','GeologieValue','geologie','Géologie de la zone considérée.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('acidite','AciditeValue','acidite','Acidité du sol.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('OGAM_ID_table_habitat','IDString','Clé primaire table habitat','Clé primaire table habitat',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('identifianthabsinp','CharacterString','identifiantHabSINP','Identifiant unique de l''habitat observé.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('cdhab','CodeHabRefValue','cdHab','Code l''habitat suivant HABREF.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('typedeterm','TypeDeterminationValue','typeDeterm','Type de détermination.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('determinateur','CharacterString','determinateur','Personne ayant procédé à la détermination du code de l''habitat contenu dans cdHab, ainsi que son éventuel organisme.',NULL);
INSERT INTO data(data,unit,label,definition,comment) VALUES ('techniquecollecte','TechniqueCollecteValue','techniqueCollecte','Technique de collecte ayant permis la génération de l''observation.',NULL);
...
INSERT INTO standard(name,label,version) VALUES ('occtax','Standard d''occurences de taxons','v1.2.1');
INSERT INTO standard(name,label,version) VALUES ('habitat','Standard d''occurences d''habitats','v1.0');
...
INSERT INTO model(id,name,description,schema_code,is_ref,status,created_at,standard) VALUES ('model_1000','Occ_Habitat_DSR_1.0','Implémentation du standard "Occurences d''habitats" v1.0','RAW_DATA',TRUE,'unpublished',NULL,'habitat');
